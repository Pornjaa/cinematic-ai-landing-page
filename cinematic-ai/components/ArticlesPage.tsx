...
const ArticlesPage: React.FC<ArticlesPageProps> = ({ onReadArticle }) => {
  return (
    <div className="pt-24 pb-20 min-h-screen bg-cinematic-900 text-white animate-fade-in">
      <SEO 
        title="บทความและเทคนิค AI Filmmaking" 
        description="รวมบทความสอนใช้งาน Kling, Nano Banana, Sora2 และอัปเดตข่าวสารวงการ AI Art และภาพยนตร์"
      />
      ...
      <div className="container mx-auto px-6 mb-16 text-center">
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed font-light">
          แหล่งรวมความรู้ แรงบันดาลใจ และเทคนิคใหม่ๆ เกี่ยวกับการใช้ AI ในโลกภาพยนตร์
        </p>
      </div>
          ...
          {ARTICLES_DATA?.map((article) => (
            ...
            >
              <div className="h-48 overflow-hidden relative">
                ...
                {article.youtubeId && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-12 h-12 bg-cinematic-accent rounded-full flex items-center justify-center">
              ...
              <div className="p-6">
                ...
                <span className="text-cinematic-accent text-sm font-medium flex items-center gap-1">
