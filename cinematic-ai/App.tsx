...
import ImageToPromptBuddy from './components/ImageToPromptBuddy';
...
const App: React.FC = () => {
  const getPageFromPath = () => {
    try {
      ...
      if (path === '/vision-analyst') return 'vision-analyst';
      return 'home';
    } catch (e) {
      return 'home';
    }
  ...
  const handleNavigate = useCallback((pageId: string) => {
    ...
    switch (pageId) {
      ...
      case 'vision-analyst': targetPath = '/vision-analyst'; break;
      default: targetPath = '/';
    }
