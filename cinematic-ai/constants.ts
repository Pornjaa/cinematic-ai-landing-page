...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'AI Vision Analyst', id: 'vision-analyst' },
  { label: 'Character Prompter', id: 'character-prompter' },
  { label: 'AI Video Motion', id: 'video-motion' },
...
export const ARTICLES_DATA: Article[] = [
  ...
  {
    id: 'nano-banana-pro-review',
    title: 'กล้วยที่ไม่เคยกล้วย (Nano Banana Pro)',
    excerpt: 'หลังปล่อย nano banana ได้ไม่นาน google ก็ปล่อยอัพเกรดตามมาติดๆ ที่รอบนี้ดีขึ้น เทพขึ้นในทุกๆ ด้าน',
    content: [
  ...
  {
    id: 'kling-ai-o1-world-change',
    title: 'Kling AI O1 อัพเกรดเปลี่ยนโลก',
    excerpt: 'เปิดให้ทดลองใช้กันแล้วสำหรับ Kling o1 โมเดลล่าสุดที่ไม่ใช่แค่โมเดลใหม่ แต่คือการคิดใหม่ทำใหม่',
    content: [
